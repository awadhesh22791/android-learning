...
public class SecondFragment extends AbstractFragment {
    ...
    private Button buttonToThirdFragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonToThirdFragment=view.findViewById(R.id.button_to_third_fragment);
    ...
    View.OnClickListener buttonToThirdFragmentListener=new View.OnClickListener(){
        @Override
